...
public class DetalleRestaurant extends Activity {
	
	private RestauranteItem item;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		item=ItemChache.restaurantItem;
		initViews();
		new AsyncTaskDownload(this).execute();
	}
	
	private void initViews(){
		imageContainer=(RelativeLayout)findViewById(R.id.containerRestaurantImage);
		tvNombre=(TextView)findViewById(R.id.tvNombreRestaurant);
		tvInformacion=(TextView)findViewById(R.id.tvInfoRestaurante);
		tvZona=(TextView)findViewById(R.id.tvZonaRestaurante);
		tvTipoComida=(TextView)findViewById(R.id.tvTipoComidaRestaurante);
		...
		tvTipoComida.setText(item.getComida());
	}
