...
public class DetailVidaNocturna extends Activity {

	private VidaNocturnaItem item;
	private RelativeLayout imageContainer;
	private TextView tvNombre;
	private TextView tvInformacion;
	private TextView tvZona;
	private TextView tvTipoTour;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_detail_vida_nocturna);
		
		item=ItemChache.vidaItem;
		initViews();
		new AsyncTaskDownload(this).execute();
	}
	
	private void initViews(){
		imageContainer=(RelativeLayout)findViewById(R.id.containerVidaImage);
		tvNombre=(TextView)findViewById(R.id.tvNombreVida);
		tvInformacion=(TextView)findViewById(R.id.tvInfoVida);
		tvZona=(TextView)findViewById(R.id.tvZonaVida);
		tvTipoTour=(TextView)findViewById(R.id.tvTipoVida);
		...
		tvTipoTour.setText(item.getCategoria());
	}
