...
public class DetalleTour extends Activity {

	private ToursItem item;
	...
	private void initViews(){
		imageContainer=(RelativeLayout)findViewById(R.id.containerTourImage);
		tvNombre=(TextView)findViewById(R.id.tvNombreTour);
		tvInformacion=(TextView)findViewById(R.id.tvInfoTour);
		tvZona=(TextView)findViewById(R.id.tvZonaTour);
		tvTipoTour=(TextView)findViewById(R.id.tvTipoTour);
		...
		tvTipoTour.setText(item.getTour());
	}
